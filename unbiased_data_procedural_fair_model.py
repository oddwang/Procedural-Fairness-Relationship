## RQ1.1 Does the ML model exhibit distributive fairness when the dataset is unbiased and the ML model is procedural-fair?
...
def explain_loss(y_true, y_pred):
    ...
    return bce + 0.1 * (distance1_mean + distance2_mean)
